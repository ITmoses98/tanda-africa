  ...
  const sections = [
    {
      ...
      items: [
        ...
        { path: "/admin/books", label: "Books", icon: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" },
        ...
        { path: "/admin/shipping", label: "Shipping", icon: "M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10l2-1m4-1l2 1 4-1 2 1M7 17v2m10-2v2" },
      ]
    },
    {
      label: "Commerce",
      items: [
        { path: "/admin/sellers", label: "Sellers", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" },
        { path: "/admin/coupons", label: "Coupons & Discounts", icon: "M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A2 2 0 013 12V7a4 4 0 014-4z" },
    ...
    },
    {
      label: "Insights",
      items: [
        { path: "/admin/reports", label: "Sales Reports", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
        { path: "/admin/analytics", label: "Analytics", icon: "M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" },
      ]
    },
    {
      label: "Users & Roles",
    ...
    <div className="adm-layout">
      <aside className={`adm-sidebar ${sidebarOpen ? "open" : ""}`}>
        ...
        <div className="adm-sidebar-footer">
          <img src={user?.avatar} alt="" className="adm-avatar" />
          <div className="adm-user-info">
            <span className="adm-user-name">{user?.name}</span>
            <span className="adm-user-role">{user?.role === "admin" ? "Administrator" : "Staff"}</span>
          </div>
          <button onClick={handleLogout} className="btn-link" title="Sign Out">⏻</button>
        </div>
      </aside>
      ...
      <div className="adm-content">
        <header className="adm-content-header">
          ...
          <div className="adm-breadcrumb">Admin / <span>{location.pathname.split("/").pop() || "Dashboard"}</span></div>
